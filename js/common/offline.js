...
export const offline = (() => {
    ...
    const setOffline = () => {
        ...
        el.firstElementChild.innerHTML = '<i class="fa-solid fa-ban me-2"></i>Connection not available.';
    };
    ...
    const setOnline = () => {
        ...
        el.firstElementChild.innerHTML = '<i class="fa-solid fa-cloud me-2"></i>Connection available again.';
    };
