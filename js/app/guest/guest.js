...
export const guest = (() => {
    ...
    const buildGoogleCalendar = () => {
        ...
        const data = {
            action: 'TEMPLATE',
            text: 'The Wedding of Ankit and Dimpi',
            dates: `${formatDate('2025-05-05 17:00')}/${formatDate('2025-05-05 18:00')}`,
            details: 'Join us as we celebrate the union of Ankit and Dimpi in a joyous wedding ceremony. Your presence will make this special day even more memorable. Let’s come together to bless the couple and share in their happiness!',
            location: 'https://maps.app.goo.gl/RVBU2ZPAYksKu8Xe8',
            ctz: 'Asia/Mumbai',
        };
